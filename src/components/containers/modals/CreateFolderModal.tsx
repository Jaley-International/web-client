                ...
                <div className="rounded-2xl bg-grey-75 blur-md shadow-2xl">
                    ...
                    <div className="py-8 px-20">
                        ...
                        <form onSubmit={async (e) => {
                            ...
                            <TextInput ref={nameRef} type="text" label="Folder name" name="folder-name" autoFocus={true} required={true} validator={(str: string) => /^[0-9a-zA-Z-_àéèêëîïÀÉÈÊËÎÏçÇ ]{1,32}$/.test(str)} />
