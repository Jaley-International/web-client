...
function DeleteUserModal(props: Props): JSX.Element {
    return (
        <div className="z-10 absolute w-full h-full bg-white bg-opacity-40 firefox:bg-opacity-40 backdrop-filter backdrop-blur-sm">
                ...
                <div className="rounded-2xl bg-grey-75 blur-md shadow-2xl">
                    ...
                    <div className="py-8 px-20">
                        <p className="text-txt text-center">
                            Are you sure you want to delete user "<span className="font-semibold">{props.user.firstName} {props.user.lastName}</span>" ?<br />
