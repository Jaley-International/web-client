                        ...
                        <Card title="Edit account informations" separator={false}>
                            <form className="space-y-2 m-6 pb-4" onSubmit={async (e) => {
                                ...
                                <div className="lg:flex">
                                    <TextInput ref={firstnameRef} className="lg:w-1/3 lg:pr-4" type="text" autoComplete="given-name" label="First name" placeholder={user.firstName} name="firstname" minLength={1} maxLength={32} validator={(str: string) => /^[0-9a-zA-Z-]{0,32}$/.test(str)} />
                                    <TextInput ref={lastnameRef} className="lg:w-1/3 lg:px-2" type="text" autoComplete="family-name" label="Last name" placeholder={user.lastName} name="lastname" minLength={1} maxLength={32} validator={(str: string) => /^[0-9a-zA-Z-]{0,32}$/.test(str)} />
                                    <TextInput ref={emailRef} className="lg:w-1/3 lg:pl-4" type="email" autoComplete="email" label="Email address" placeholder={user.email} name="email" validator={(str: string) => str.length == 0 || /\S+@\S+\.\S+/.test(str)} />
                                </div>
                                <div className="lg:flex">
                                    <Select ref={groupRef} className="lg:w-1/3 lg:pr-4" label="Group">
                                        <option selected={user.group === "Clients"}>Clients</option>
                                        <option selected={user.group === "Debt recovery department"}>Debt recovery department</option>
                                        <option selected={user.group === "Human resources"}>Human resources</option>
                                        <option selected={user.group === "Legal department"}>Legal department</option>
                                    </Select>
                                    <Select ref={jobRef} className="lg:w-1/3 lg:px-2" label="Job title">
                                        <option selected={user.job === "CEO"}>CEO</option>
                                        <option selected={user.job === "Debt Collection Officer"}>Debt Collection Officer</option>
                                        <option selected={user.job === "HR director"}>HR director</option>
                                        <option selected={user.job === "Individuals Litigation Collection Officer"}>Individuals Litigation Collection Officer</option>
                        ...
                        <div className="flex space-x-6">
                            <Card className="text-orange-light w-1/2" title="Suspend account" separator={false}>
                                <div className="flex text-txt-body px-6 pb-6 pt-2">
                                    ...
                                    <div className="w-96 text-center my-auto h-full">
                                        <Button size="medium" type="regular" colour="orange" onClick={() => {alert("TODO User suspension")}}>Suspend account</Button>
                                    </div>
                                </div>
                            </Card>
                            <Card className="text-red w-1/2" title="Delete account" separator={false}>
                                <div className="flex text-txt-body px-6 pb-6 pt-2">
                                    ...
                                    <div className="w-96 text-center my-auto h-full">
                                        <Button size="medium" type="regular" colour="red" onClick={() => {alert("TODO User deletion")}}>Delete account</Button>
                                    </div>
                                </div>
                            </Card>
                        </div>
